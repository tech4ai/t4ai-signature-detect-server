...
def main():
    # Paths
    root_dir_images = "/home/samuel/Downloads/Signature Detection.v2i.coco/test/"
    ...
    if use_vertex_ai:
        predictor = VertexAIPredictor(
            url="https://8605861017928335360.us-central1-100881400340.prediction.vertexai.goog/v1/projects/100881400340/locations/us-central1/endpoints/8605861017928335360:rawPredict",
        )
    else:
