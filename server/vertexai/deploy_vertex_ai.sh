...
NGC_TRITON_TAG ="us-central1-docker.pkg.dev/tech4ai-develop/t4ai-nvidia-triton/vertex-triton-inference:24.11"
...
gcloud ai models upload \
    ...
    --artifact-uri=gs://iag-training/triton-server/image/signature-detection/models \
